package com.rayzr522.battlebricks.utils;
...
public class ActionBarUtil {
    ...
    static {
        try {
            ...
            String NMS = "net.minecraft.server." + BV + ".";
            String OBC = "org.bukkit.craftbukkit." + BV + ".";

            chatSer = Class.forName(NMS + "ChatComponentText").getConstructor(String.class);

            packetChat = Class.forName(NMS + "PacketPlayOutChat").getConstructor(Class.forName(NMS + "IChatBaseComponent"), byte.class);

            getPlayerHandle = Class.forName(OBC + "entity.CraftPlayer").getDeclaredMethod("getHandle");

            playerConnection = Class.forName(NMS + "EntityPlayer").getDeclaredField("playerConnection");
